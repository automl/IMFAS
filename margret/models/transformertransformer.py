...
from margret.models.transformerMLP import margretTransformerMLP


class margretTransformerSubsequent(margretTransformerMLP):
    def __init__(self, transformer_algos, *args, **kwargs):
        super(margretTransformerSubsequent, self).__init__(*args, **kwargs)
