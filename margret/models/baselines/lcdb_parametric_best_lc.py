...
from margret.models.baselines.lcdb_parametric_lc import ParametricLC
from margret.utils.modelinterface import ModelInterface
...
if __name__ == "__main__":
    from margret.data.lcbench.example_data import train_dataset
    from margret.evaluation.topkregret import TopkRegret
