"""
Defines an alternative to margretTransformerMLP.transformer_lc that uses guided attention.
...
#
class margretGuidedAttentionTransformerEncoder(nn.TransformerEncoder):
    def __init__(self, metaf_embed_dim, l_seq, hidden_dims=tuple(), *args, **kwargs):
        ...
        super(margretGuidedAttentionTransformerEncoder, self).__init__(*args, **kwargs)
