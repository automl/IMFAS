...
if __name__ == "__main__":
    ...
    from margret.models.baselines.successive_halving import SuccessiveHalving
    from margret.losses.spearman import SpearmanLoss
    from margret.utils.masking import mask_lcs_to_max_fidelity, mask_lcs_randomly
    from margret.data.lcbench.example_data import data_path, pipe_lc, pipe_meta
    from margret.evaluation.topkregret import TopkMaxRegret

    from margret.utils.util import seed_everything
    ...
    for seed in range(35):  # to vary across datasets & learning processes.
        ...
        from margret.data import Dataset_Join_Dmajor, Dataset_LC, DatasetMetaFeatures
        from margret.utils.traintestsplit import leave_one_out
        ...
        wandb.init(entity="example", mode="online", project="margret-iclr", job_type="base: sh, leave one out", group="sh")
        ...
        from margret.models.margret_wp import margret_WP
        from margret.utils.mlp import MLP

        wandb.init(
            entity="example",
            mode="online",
            project="margret-iclr",
            job_type="base: margret_wp rnd. masking, leave one out",
            group="margret_wp",
        )
