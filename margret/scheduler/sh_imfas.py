...
class SH_margret(SuccessiveHalving):
    ...
    def __repr__(self):
        return (
            f"SH_margret(model={self.model}," f"budgets={self.budgets}, eta={self.eta}, budget_type={self.budget_type})"
        )
    ...
    def kill_low_performers(self, learning_curves, k, survivors, **kwargs):
        # assuming that the model is margret_iclr transformer
